<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        move_uploaded_file($_FILES['musiq_coverart']['tmp_name'],'https://files.sweetsound.co.za/images/musiq_images/'.$musiq_coverart);

        $extension2 = explode(".", $_FILES['musiq_file']['name']);
        $musiq_file =  $musiq_title.'.'.end($extension2);
        move_uploaded_file($_FILES['musiq_file']['tmp_name'],'https://files.sweetsound.co.za/musiq/songs/singles/'.$musiq_file);
        ...
        $ins_musiq = "INSERT INTO musiq (artist_id, active_yn, musiq_type, musiq_title, musiq_title_slug, musiq_genre, musiq_coverart, musiq_file, musiq_release_date, musiq_downloads, musiq_plays, musiq_likes, musiq_page_views)
                    VALUES ('$artist_id', 0, 'Single', '$musiq_title', '$musiq_title_slug', '$musiq_genre', '$musiq_coverart', '$musiq_file', '$musiq_release_date', 0, 0, 0, 0)";
        ...
        echo '<meta http-equiv="refresh" content="60; url= upload-song.php">';
      }
?>
<!doctype html>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="bootstrap-select fm-cmp-mg">
                                        <select class="selectpicker" data-live-search="true" name="musiq_genre" required>
                                            ...
                                            <option value="Amapianos">Amapiano</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
