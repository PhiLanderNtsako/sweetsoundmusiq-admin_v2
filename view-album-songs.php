                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                        <div class="basic-tb-hd">
                            <h2><?php echo $row2['musiq_title'] ?></h2>
                        </div>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td width="15px">
                                                ...
                                                <a href="../musiq/<?php echo $row['artist_name_slug'].'/'.$row['musiq_title_slug'] ?>">https://www.sweetsound.co.za/musiq/<?php echo $row['artist_name_slug'].'/'.$row['musiq_title_slug'] ?></a>
