<?php
	...
	if (isset($_POST['submit'])) {
		  ...
		  $check_admin_username = "SELECT * FROM admin WHERE admin_username = '$admin_username'";
...
<head>
    ...
    <title>Sweet Sound Musiq - Login | Sweet Sound Dashboard</title>
                            ...
                            <!-- Alert area start-->
                                <div class="alert-inner">
                                    <div class="alert-list">
                                        <div class="alert alert-danger alert-mg-b-0" role="alert"><?php echo $error ?>
                                        </div>
                                    </div>
                                </div>
                <?php   
